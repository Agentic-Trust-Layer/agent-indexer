...
export class MultiAttestCall__Inputs {
  ...
  get multiRequests(): Array<MultiAttestCallMultiRequestsStruct> {
    return this._call.inputValues[0].value.toTupleArray<MultiAttestCallMultiRequestsStruct>();
  }
}
...
export class MultiAttestByDelegationCall__Inputs {
  ...
  get multiDelegatedRequests(): Array<MultiAttestByDelegationCallMultiDelegatedRequestsStruct> {
    return this._call.inputValues[0].value.toTupleArray<MultiAttestByDelegationCallMultiDelegatedRequestsStruct>();
  }
}
...
export class MultiAttestByDelegationCallMultiDelegatedRequestsStruct extends ethereum.Tuple {
  ...
  get data(): Array<MultiAttestByDelegationCallMultiDelegatedRequestsDataStruct> {
    return this[1].toTupleArray<MultiAttestByDelegationCallMultiDelegatedRequestsDataStruct>();
  }

  get signatures(): Array<MultiAttestByDelegationCallMultiDelegatedRequestsSignaturesStruct> {
    return this[2].toTupleArray<MultiAttestByDelegationCallMultiDelegatedRequestsSignaturesStruct>();
  }
...
export class MultiRevokeCall__Inputs {
  ...
  get multiRequests(): Array<MultiRevokeCallMultiRequestsStruct> {
    return this._call.inputValues[0].value.toTupleArray<MultiRevokeCallMultiRequestsStruct>();
  }
}
...
export class MultiRevokeByDelegationCall__Inputs {
  ...
  get multiDelegatedRequests(): Array<MultiRevokeByDelegationCallMultiDelegatedRequestsStruct> {
    return this._call.inputValues[0].value.toTupleArray<MultiRevokeByDelegationCallMultiDelegatedRequestsStruct>();
  }
}
...
export class MultiRevokeByDelegationCallMultiDelegatedRequestsStruct extends ethereum.Tuple {
  ...
  get data(): Array<MultiRevokeByDelegationCallMultiDelegatedRequestsDataStruct> {
    return this[1].toTupleArray<MultiRevokeByDelegationCallMultiDelegatedRequestsDataStruct>();
  }

  get signatures(): Array<MultiRevokeByDelegationCallMultiDelegatedRequestsSignaturesStruct> {
    return this[2].toTupleArray<MultiRevokeByDelegationCallMultiDelegatedRequestsSignaturesStruct>();
  }
